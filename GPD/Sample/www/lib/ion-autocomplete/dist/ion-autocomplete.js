        ...
        return {
            ...
            controller: ['$attrs', '$timeout', '$scope', function ($attrs, $timeout, $scope) {
                ...
                $timeout(function () {
                    ...
                    controller.selectItemsLabel = valueOrDefault(controller.selectItemsLabel, "Select a VSTS Team...");
                    controller.selectedItemsLabel = valueOrDefault(controller.selectedItemsLabel, $interpolate("Selected VSTS Teams{{maxSelectedItems ? ' (max. ' + maxSelectedItems + ')' : ''}}:")(controller));
                ...
                $q.when().then(function () {
                    ...
                    scope.$watch('viewModel.maxSelectedItems', function (maxSelectedItems) {
                        ...
                        if (ionAutocompleteController.maxSelectedItems != maxSelectedItems) {
                            ionAutocompleteController.selectedItemsLabel = $interpolate("Selected VSTS Teams{{maxSelectedItems ? ' (max. ' + maxSelectedItems + ')' : ''}}:")(ionAutocompleteController);
                        }
                    });
