            ...
            '<div class="filter-bar-wrapper filter-bar-{{::config.theme}} filter-bar-transition-{{::config.transition}}">' +
              '<div class="bar bar-header bar-{{::config.theme}} item-input-inset">' +
                ...
                '<label class="item-input-wrapper">' +
                  '<input  id="search-work-items" type="search" autofocus class="filter-bar-search" ng-model="data.filterText" placeholder="{{::config.placeholder}}"/>' +
                  '<button class="filter-bar-clear button button-icon icon" ng-class="getClearButtonClass()"></button>' +
                   '<button class="filter-bar-android-vsts-search button button-clear" ng-click="filterUi()">Search</button>' +
                '</label>' +
              '</div>' +
            '</div>';
        } else {
            ...
            '<div class="filter-bar-wrapper filter-bar-{{::config.theme}} filter-bar-transition-{{::config.transition}}">' +
              '<div class="bar bar-header bar-{{::config.theme}} item-input-inset">' +
                '<label class="item-input-wrapper">' +
                  ...
                  '<button class="filter-bar-clear button button-icon icon" ng-class="getClearButtonClass()"></button>' +
                '</label>' +
                '<button class="filter-bar-vsts-search button button-clear" ng-click="filterUi()">Search</button>' +
    ...
    .factory('$ionicFilterBar', [
      ...
      function ($document, $rootScope, $compile, $timeout, $filter, $ionicPlatform, $ionicFilterBarConfig, $ionicConfig, $ionicModal, $ionicScrollDelegate) {
        ...
        function filterBar (opts) {
          ...
          if(scope.vstsSearchString!==undefined||scope.vstsSearchString!==''){
            
               scope.data.filterText = scope.vstsSearchString;             
          }
